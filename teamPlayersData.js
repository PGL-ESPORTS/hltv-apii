...
//   console.log(playerObj);
  ...
  playersName.forEach(async (playerName) => {
        ...
        http.open("get", `https://www.hltv.org/api/event/player/${playerName}?startDate=2021-01-01&endDate=2021-07-12`, false, username, password);
        http.send("");
        ...
        if (http.status == 200) {
            ...
            var vgmUrl = `https://www.hltv.org/stats/players/clutches/${id}/1on1/${makeSlug(name)}?startDate=2021-01-12&endDate=2021-07-12`;
            ...
            maps.forEach(map =>{
                ...
                http.open("get", `https://www.hltv.org/api/event/player/${playerName}?startDate=2021-01-01&endDate=2021-07-12&maps=${map}`, false, username, password);
                http.send("");
                if (http.status == 200) {
